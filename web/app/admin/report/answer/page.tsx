import { getParticipantsWhoVotedAnswer, } from "@/lib/source-api"
...
export default async function AnswerReport({
  searchParams,
}: {
  ...
  const data = await getParticipantsWhoVotedAnswer(id, pageSize, pageNumber, search, orderColumn, orderDirection)
  const downloadLink = "/api/file/a" + createPagingSearchQuery(undefined, undefined, search, orderColumn, orderDirection,id)
