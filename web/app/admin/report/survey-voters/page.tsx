import { getParticipantsWhoVotedSurvey } from "@/lib/source-api"
...
export default async function QuestionReport({
  ...
  const data = await getParticipantsWhoVotedSurvey(id, pageSize, pageNumber, search, orderColumn, orderDirection)
  const downloadLink = "/api/file/survey" + createPagingSearchQuery(undefined, undefined, search, orderColumn, orderDirection, id)
