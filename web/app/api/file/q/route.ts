...
console.log(searchParams.toString(),'sorun');

  const response = await fetch(process.env.DB_API_URL + '/participant/download-who-voted-question?' + searchParams.toString(), {
    method: "GET",
    headers: {
