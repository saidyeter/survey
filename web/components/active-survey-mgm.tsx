      ...
      <Card>
        ...
        <CardContent>
          ...
          {((startedCount || startedCount == 0) && totalParticipants && (finishedCount || finishedCount == 0)) ?
            <>
              <p className="mt-4">Toplam {totalParticipants} içinden {startedCount} kişi oylamaya başlamış, {finishedCount == startedCount && finishedCount > 0 ? 'hepsi' : finishedCount + ' kişi'} oylamayı tamamlamıştır.</p>
              <p>
                <Link
